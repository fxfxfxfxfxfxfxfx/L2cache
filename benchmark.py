#!/usr/bin/env python3
"""Sparse MLA benchmark for a single NVIDIA H800 SXM (SM90).
...
def write_environment(raw_dir: str, project_dir: str, seed: int):
    ...
    wheels_dir = os.path.join(project_dir, "assets", "wheels")
...
def main(argv=None):
    ...
    out_dir = args.output_dir or os.path.join(project_dir, "assets")
